...
public class TesteABB {
    ...
    public static void testarCenario(int tamanho, String tipo) throws IOException {
        ...
        escrever("\n============================================");
        escrever("\n   ARVORE BINARIA - " + tamanho + " elementos - " + tipo);
        escrever("\n============================================\n");
        ...
        escrever("  inexistente: " + medirBusca(dados, inexistente) + " ms\n");
    ...
    public static void main(String[] args) {
        try {
            arquivo = new FileWriter("resultados_abb.txt");
            ...
            arquivo.close();
            System.out.println("\nArquivo 'resultados_abb.txt' gerado com sucesso!");
